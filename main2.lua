...
local BannedPlayers = {
	...
	{User = "rivers_11", Id = 743542509, Reason = "Nilling issue"}; {User = "fireball_3000", Id = 133417803, Reason = "Nilling issue; Suspended for a week"}; {User = "mynewusername2233", Id = 120110304, Reason = "Nilling issue"};
}
